package com.wlsup.yygh.user.service.impl;

import com.wlsup.yygh.common.exception.HospitalException;
import com.wlsup.yygh.common.helper.JwtHelper;
import com.wlsup.yygh.common.result.ResultCodeEnum;
import com.wlsup.yygh.enums.AuthStatusEnum;
import com.wlsup.yygh.model.user.Patient;
import com.wlsup.yygh.model.user.UserInfo;
import com.wlsup.yygh.user.mapper.UserInfoMapper;
import com.wlsup.yygh.user.service.PatientService;
import com.wlsup.yygh.user.service.UserInfoService;
import com.wlsup.yygh.vo.user.LoginVo;
import com.wlsup.yygh.vo.user.UserAuthVo;
import com.wlsup.yygh.vo.user.UserInfoQueryVo;
...
public class UserInfoServiceImpl extends ServiceImpl<UserInfoMapper, UserInfo> implements UserInfoService {
    ...
    public Map<String, Object> login(LoginVo loginVo) {
        ...
        //如果是微信扫码登录，则Openid有值，则绑定手机号码，执行后userInfo就!=null了不会走57行的手机号登录
